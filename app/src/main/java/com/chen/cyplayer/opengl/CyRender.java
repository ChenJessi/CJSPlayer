...
public class CyRender implements GLSurfaceView.Renderer {
    ...
    private void renderYUV() {
        if (width_yuv > 0 && height_yuv > 0 && y != null && u != null && v != null) {
            ...
            GLES20.glBindTexture(GLES30.GL_TEXTURE_2D, textureId_yuv[0]);
            ...
            GLES20.glBindTexture(GLES30.GL_TEXTURE_2D, textureId_yuv[1]);
            ...
            GLES20.glBindTexture(GLES30.GL_TEXTURE_2D, textureId_yuv[2]);
